...
import { IClassTeacherDropdownBody,IStudentsListBody,ITermDropdownBody,IUpdateStudentDetailsBody } from "src/interfaces/TermwiseHeightWeight/ITermwiseHeightWeight";
...
export const TeacherNameList =
  ...
  (data: ITermDropdownBody): AppThunk =>
    ...
    async (dispatch) => { 
        ...
        dispatch(TermwiseHeightWeightSlice.actions.updatestudentlist(response.data));
    };
