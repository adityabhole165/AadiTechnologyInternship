...
export const GetAllClassAndDivision =
  ...
  async (dispatch) => {
    ...
    dispatch(
      EventDescriptionSlice.actions.getAllClassesAndDivisionss(responseData)
    );
...
export const GetSelectedStandardAndDivisionCheckBoxx =
  ...
  async (dispatch) => {
    const response =
      await GetEventDescriptionApi.SelectedStandardAndDivisionCheckBox(data);
    dispatch(
      EventDescriptionSlice.actions.getSelectedStandardAndDivisionCheckBoxx(
        response.data
      )
    );
  };
