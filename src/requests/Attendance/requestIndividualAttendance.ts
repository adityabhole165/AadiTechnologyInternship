...
import { getAttendanceLegend, getDateFormatted, getDateMonthYearFormattedDash } from "src/components/Common/Util";
...
export const getstudentname = (data: IGetStudentNameBody): AppThunk =>
    async (dispatch) => {
...
export const getcalendar = (data: IGetCalendarForStudentBody): AppThunk =>
    async (dispatch) => {
...
export const SaveStudentAttendance = (data: ISaveStudentAttendanceBody): AppThunk => async (dispatch) => {
