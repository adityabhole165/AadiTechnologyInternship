...
const GetExamResultslice = createSlice({
  ...
  reducers: {
    ...
    getProgressReportFileName(state, action) {
      state.ProgressReportFileName =
        action.payload.GetProgressReportFileNameResult;
    },
...
export const GetReasonforBlockingProgressReport =
  ...
  async (dispatch) => {
    const response = await GetExamResultApi.GetReasonforBlockingProgressReport(
      data
    );
    dispatch(
      GetExamResultslice.actions.getReasonforBlockingProgressReport(
        response.data
      )
    );
  };
...
export const GetProgressReportFileName =
  ...
  async (dispatch) => {
    ...
    dispatch(
      GetExamResultslice.actions.getProgressReportFileName(response.data)
    );
  };
...
export const AcademicProgressReportDownload =
  ...
  async (dispatch) => {
    const response = await GetExamResultApi.AcademicYearsForProgressReport(
      data
    );
...
export const GetTermsForProgressReport =
  ...
  async (dispatch) => {
    ...
    dispatch(
      GetExamResultslice.actions.getTermsForProgressReport(response.data)
    );
  };
