...
const NewRelease = Loader(lazy(() => import('src/components/Authentication/NewRelease/NewRelease'))); 
const UpgradeApp = Loader(lazy(() => import('src/components/Authentication/NewRelease/UpgradeApp'))); 
