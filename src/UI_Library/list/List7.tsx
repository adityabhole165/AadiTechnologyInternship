...
import {
  Button, Box, Container, TextField, Grid, IconButton, Paper, List, Card,
  useTheme, Typography, CardHeader, Divider
} from '@mui/material';
import PropTypes from 'prop-types';
import { Styles } from 'src/assets/style/student-style';
import{ GetFMsgfromResult} from 'src/Interface/Student/dashboard'
