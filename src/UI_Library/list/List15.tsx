...
function List15({ StartDate, StartTime, EndTime, SubjectName, TestType, index, Instruction, ExamId, Description }) {
                    ...
                    <List
...

                        {
                            (Description !== " ") ?
                                ...
                                <>
                                    <Typography className={classes.Listfont2} sx={{ color: 'darkmagenta' , marginTop: '0px'}}>
                                              <b>{Description}</b>
                                    </Typography>
                                </> :
                                null
