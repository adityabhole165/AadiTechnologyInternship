...
import { IUpdateTeacherAadharDetailsBody, IDeleteAadharCardPhotoCopyBody, IGetUserDetailsForAadharCardNoBody } from 'src/interfaces/NewAadharcardTeachers/IAadharcardTeacher';
import SingleFile from 'src/libraries/File/SingleFile';
import PageHeader from 'src/libraries/heading/PageHeader';
import { CDAUpdateTeacherAadharDetails, CDADeleteAadharCardPhotoCopy, CDAGetUserDetailsForAadharCardNo } from 'src/requests/NewAadharcard/RAadharcardTecaher';
