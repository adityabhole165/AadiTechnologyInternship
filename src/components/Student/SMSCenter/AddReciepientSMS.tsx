...
import SelectallAddrecipents from 'src/components/MessageCenter/SelectallAddrecipents';
import {
...
const AddReciepentsSMS = ({ RecipientName, RecipientId, recipientListClick }) => {
...
export default AddReciepentsSMS;
