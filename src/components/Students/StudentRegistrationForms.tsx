...
const StudentRegistrationForm = () => {
  ...
  const { Name, standardId, DivisionId, YearWise_Student_Id, SchoolWise_Student_Id, StandardDivision_Id, Enrolment_Number, Joining_Date } = location.state || {};
  ...
  const handleFileUpload = (file) => {
    ...
    if (file && ValidFileTypes.includes(`${file.FileExtension}`) && fileSize <= MaxAchievementfileSize) {
  ...
  let url = localStorage.getItem("SiteURL") + "RITeSchool/DOWNLOADS/StudentAchievement/"
