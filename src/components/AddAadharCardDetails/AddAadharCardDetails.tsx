...
import { Box, Button, Container, Grid, Typography ,TextField,Grow} from '@mui/material'
...
const AddAadharCardDetails = () => {
    ...
    const AddAadharCarddetails = useSelector(
      (state: RootState) => state.AddAadharCardDetails.ISAddAadharCardDetails
    );
    console.log(AddAadharCarddetails, 'SubmitAadharCarddetails');

    const SubmitAadharCarddetails = useSelector(
      (state: RootState) => state.AddAadharCardDetails.ISSubmitAadharCardDetailsS
    );
