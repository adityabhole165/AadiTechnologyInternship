...
/>
    ...
    <br></br>
    <br></br>
    <Assignedhomeworklist ItemList={Subjectlistsforteacher} clickView={""} clickDelete={""} clickEdit={""} clickVisibilityIcon={""} clickpublish={clickPublishUnpublish}
      HeaderArray={HeaderPublish} clickAttachment={""} /><br></br>
    <br></br>
