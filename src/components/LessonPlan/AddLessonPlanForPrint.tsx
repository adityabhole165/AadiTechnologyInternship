...
const AddLessonPlanPrint = ({ valueProp }) => {
    // const { UserIdParam, StartDateParam, EndDateParam, Action } = useParams()
    // userId:  '',
    // startDate: '',
    // endDate: ''

    const UserIdParam = valueProp?.userId;
    const StartDateParam = valueProp?.startDate;
    const EndDateParam = valueProp?.endDate;
    const Action = valueProp?.action ?? 'Edit';
            ...
            <Box sx={{ p: 2, background: 'white' }}>
                <Grid container spacing={2}>
                    ...
                    {Loading ? <SuspenseLoader /> : <Grid item xs={12}>
                        ...
                        <LessonPlanListPrint exampleLessonDetails={exampleLessonDetails} />
                    </Grid>
                    }
                </Grid>
            </Box>
...
export default AddLessonPlanPrint;
