  ...
  return (
    <Container>
      ...
      <p>
        ...
        The following are the Terms and Conditions for online Payments. Please go through the same carefully.
        <hr />
        1. I / We agree and accept the services provided by Axis Bank and Aggregator. At my / our request to carry out my payments on my/our account, given by me / us.<br />
        2. I / We have no objection whatsoever, to the online payment facility providing my / our billing details to the Institute.<br />
        3.  While the Institute will take all reasonable  steps to ensure the accuracy of the payment details, the Institute is not liable for any error. I / We shall not hold the Institute responsible for any  loss, damages, etc. that may be incurred / suffered by me / us if the information contained turns out to be inaccurate / incorrect.<br />
        4. I / We agree that any disputes on Payment details will be settled directly with the Institute and the responsibility limited to provision of information only.<br />
        5. I / We agree that we will make bill amount  payments as required by the Institute. I / We will not hold the Institute  responsible for rejecting the payment amount because of incorrect or incomplete  entries.<br />
        6. I / We agree that the record of the instructions given and transactions with the Institute shall be conclusive proof and binding for all purposes and can be used as evidence in any  proceeding.<br />
        7. I / We agree that charges, if any, for the online payment services will be at the sole discretion of the Institute is at  liberty to vary the same from time to time, without giving any notice.<br />
