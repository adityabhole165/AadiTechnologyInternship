...
const UploadAnnualPlanner = ({ openAnnualPlannerDialog, setOpenAnnualPlannerDialog }) => {
    ...
    const FileDetails: any = useSelector((state: RootState) => state.AddPlanner.getfile);
    const AddAnnualPlanner: any = useSelector((state: RootState) => state.AddPlanner.AddAnnual);
    ...
    return (
        <> <Dialog open={openAnnualPlannerDialog} maxWidth={'sm'} fullWidth
        ...
        >
                        ...
                        {AddAnnualPlanner && (
                            <Box
                                sx={{
                                    ...
                                    fontSize: '18px', gap: 2, p: 1
                                }}
                            >
                                <CheckCircleIcon />
                                {AddAnnualPlanner?.name}
                                <IconButton color={'error'} onClick={() => { setFileName(null); }}>
                                    <DeleteIcon />
                                </IconButton>
            ...
            <DialogActions sx={{ py: 2, px: 3 }}>
                <Button color={'error'}
                    onClick={() => { setOpenAnnualPlannerDialog(false); }}
                >
                    Cancel
                </Button>
