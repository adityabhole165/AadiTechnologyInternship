...
const SearchAnnualPlanner = ({ ItemList, ClickItem, DefaultValue }) => {
    ...
    return (
        <Stack direction={'row'} gap={1}>
            <Box sx={{ minWidth: 130 }}>
                <Dropdown variant={"outlined"} Array={ItemList.StandardList}
            ...
            <Box sx={{ minWidth: 130 }}>
                <Dropdown variant={"outlined"} Array={ItemList.StandardDivisionList}
            ...
            <Box sx={{ minWidth: 130 }}>
                <Dropdown variant={"outlined"} Array={ItemList.MonthList}
            ...
            <Box sx={{ minWidth: 130 }}>
                <Dropdown variant={"outlined"} Array={ItemList.YearList}
