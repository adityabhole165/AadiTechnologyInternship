...
import {
  ...
  IGetLectureCountsForTeachersBody
} from 'src/interfaces/Teacher/ITeacherTimeTable';
import {
  IGetCheckDuplicateLecturesMsgBody,
  IGetClassTimeTableBody,
  IGetDeleteAdditionalLecturesBody,
  IGetDivisionForStdDropdownBody,
  IGetGroupwiseOptionalSubjectBody,
  IGetManageClassTimeTableBody,
  IGetResetTimetableBody,
  IGetSaveClassTimeTableBody,
  IGetSaveTeacherTimeTableBody,
  IGetTeacherAndStandardForTimeTableBody,
  IGetTeacherSubjectMaxLecDetailsBody,
  IGetTimeTableForTeacherBody,
  IGetValidateAddDataForTeacherBody,
  IGetValidateDataForClassBody1
} from 'src/interfaces/WeeklyTimeTable/IWeeklyTimetable';
...
import {
  CDAClassLecNoWeekday,
  CDAClassSubjectBaseLecList,
  CDAClearDuplicateLecturesMsg,
  CDAClearManageClassTimeTable,
  CDAClearValidateAdditionalDataForTeacher,
  CDAClearValidateAddLecTeacherData,
  CDAClearValidateClassData,
  CDAClearValidateTeacherData,
  CDAClearWeeklyClassTimetableValues,
  CDAClearWeeklyTeacherTimetableValues,
  CDADeleteAdditionalLectures,
  CDAGetDataForAddClassPopUp,
  CDAGetDataForAdditionalClasses,
  CDAGetDivisionName,
  CDAGetGroupwiseOptSub,
  CDAGetLectureNoWeekday,
  CDAGetResetTimetableMsgClear,
  CDAGetStandardNameList,
  CDAGetTeachersList,
  CDAGetTeacherSubjectMaxLecDetailsForWeekDays,
  CDAMutedDeleteAdditionalLectures,
  CDAResetDeleteAdditionalLecture,
  CDAResetDeleteAdditionalLectures,
  CDAResetTimetable,
  CDASaveAddClassTimetable,
  CDASaveAddTeacherTimetable,
  CDASaveClassTimetable,
  CDASaveClassTimetableWithIncr,
  CDASaveTeacherTimetable,
  CDASaveTeacherTimetableWithIncr,
  ResetSaveClassTimetableMsg,
  ResetSaveTeacherTimetableMsg
} from 'src/requests/WeeklyTimeTable/RequestWeeklyTimeTable';
...
const WeeklyTimetable = (props: Props) => {
  ...
  const ConfigIdForPagePermissionListString: any = sessionStorage.getItem(
    'SchoolConfiguration'
  );
  const GetValidateAddDataForTeacherMsgList: any = useSelector(
    (state: RootState) =>
      state.WeeklyTimetable.ISGetValidateAdditionalDataForTeacher
  );
  const ConfigIdForPagePermissionList = ConfigIdForPagePermissionListString
    ? JSON.parse(ConfigIdForPagePermissionListString)
    : [];
  const ConfigIdPagePersmission: any = ConfigIdForPagePermissionList?.filter(
    (item: any) => item.Configure_Id === 59
  );
  const TeachersList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISTeachersList
  );
  const LectureCountsForTeachers = useSelector(
    (state: RootState) => state.TMTimetable.ISGetLectureCountsForTeachers
  );
  const AddLecWeekDays = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISAddClassesWeekDay
  );
  const ResetTimetableMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISResetTimetableMsg
  );
  const StandardNameList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetStandardName
  );
  const SaveTeacherTimetableMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetSaveTeacherTimetableMsg
  );
  const SaveClassTimetableMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetSaveClassTimetableMsg
  );
  const DivisionNameList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetDivisionName
  );
  const MondayColumnList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetTeacherSubjectMaxLecForMon
  );
  const TuesdayColumnList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetTeacherSubjectMaxLecForTue
  );
  const WednesdayColumnList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetTeacherSubjectMaxLecForWed
  );
  const ThursdayColumnList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetTeacherSubjectMaxLecForThu
  );
  const FridayColumnList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetTeacherSubjectMaxLecForFri
  );
  const TeacherTimetableCellValues = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetLectureNoWeekday
  );
  const ApplicablesToggleData = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetApplicables
  );
  const ClassTimetableCellValues = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetClassLecNoWeekday
  );
  const WeekdayIds = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISWeekdayId
  );
  const ClassBaseLecList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISClassSubjectBaseLecList
  );
  const ClassWeeklyIds = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISClassWeekdayId
  );
  const mptInfo = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISMPTinfo
  );
  const AssemblyInfo = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISAssemblyInfo
  );
  const StayBackInfo = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISStayBackInfo
  );
  const mptInfoClass = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISMPTinfoClass
  );
  const weeklytestInfoClass = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISWeeklytestClass
  );
  const weeklyTestInfo = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISWeeklytestInfo
  );
  const AssemblyInfoClass = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISAssemblyInfoClass
  );
  const StaybackInfoClass = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISStaybackClass
  );
  const loading = useSelector(
    (state: RootState) => state.WeeklyTimetable.Loading
  );

  const loadingAdditionalLecPop = useSelector(
    (state: RootState) => state.WeeklyTimetable.LoadingAdditionalLecPop
  );
  const DeleteAddLecMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetDeleteAdditionalLectureMsg
  );
  const ManageTimeTableMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetManageClassTimeTableMsg
  );
  const TimetableDetails = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISTimetableDetails
  );
  const DeleteAddLecturesMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetDeleteAdditionalLecturesMsg
  );
  const ValidateTeacherDataMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISValidateTeacherData
  );
  const ValidateAddLecTeacherDataMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISValidateAddLecTeacherData
  );
  const ValidateClassDataMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISValidateClassData
  );
  const ExtLectCount = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISExtLectCount
  );
  const OptionalLecForClass = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISAddLecForClass
  );
  const GetGroupwiseOptSubList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetGroupwiseOptSub
  );
  const DuplicateLecturesMsg = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetCheckDuplicateLecturesMsg
  );
  const AddLecNoList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetAddLecPopUpLecNoList
  );
  const AddClassSubList = useSelector(
    (state: RootState) => state.WeeklyTimetable.ISGetAddLecPopUpClassSubList
  );
  const AddLecPopupCompClassNameDetailsList = useSelector(
    (state: RootState) =>
      state.WeeklyTimetable.ISGetAddLecPopUpCompClassNameDetailsList
  );
  const AddLecForTeacherSuccessMsg = useSelector(
    (state: RootState) =>
      state.WeeklyTimetable.ISGetValidateAdditionalDataForTeacher
  );
  ...
  const [teacherSettingsAnchorEL, setTeacherSettingsAnchorEL] =
    useState<HTMLButtonElement | null>(null);
  const [filterBy, setFilterBy] = useState<string>('Teacher');
  const [showAddAdditionalLectures, setShowAddAdditionalLectures] =
  ...
  const [isNewTeacherSelection, setIsNewTeacherSelection] =
    useState<Boolean>(false);
  ...
  useEffect(() => {
    if (
      AddLecForTeacherSuccessMsg !== undefined &&
      AddLecForTeacherSuccessMsg?.length === 0
    ) {
  ...
  function getFilteredClassSubjects(
    ...
    const matchedLectures = baseLectureList.filter(
      (lecture) =>
        lecture.WeekdayId === selectedWeekdayId &&
        lecture.LecNo === selectedLectureNumber
    );
    // Step 2: Get the Standard_Division_Id and Subject_Id from the matched lectures
    const matchedStandardDivisionId =
      matchedLectures.length > 0 ? matchedLectures[0].StdDivId : null;
    const matchedSubjectId =
      matchedLectures.length > 0 ? matchedLectures[0].SubId : null;

    // Step 3: Filter the ClassSubjectDropdownList
    const filteredClassSubjects = classSubjectDropdownList.filter(
      (subject) =>
        subject.SubId === matchedSubjectId &&
        subject.StdDivId !== matchedStandardDivisionId
    );

    // Adding the default "Select" option at the beginning of the filtered list
    filteredClassSubjects.unshift({
      Id: '0',
      StdDivId: '0',
      SubId: '0',
      Name: 'Select',
  ...
  useEffect(() => {
    if (
      ...
      AddLecForTLecNo !== '0' &&
      ClassBaseLecList.length > 0
    ) {
      const filteredArray = ClassBaseLecList?.filter(
        (item) =>
          item.Weekday_Id === AddLecForTWeekDayId &&
          item.Lecture_Number === AddLecForTLecNo
      );
  ...
  useEffect(() => {
    if (
      GetGroupwiseOptSubList.length > 0 &&
      AddLecForTWeekDayId !== '0' &&
      AddLecForTLecNo !== '0'
    ) {
      const arr = ClassBaseLecList?.filter(
        (item) =>
          item.Weekday_Id === AddLecForTWeekDayId &&
          item.Lecture_Number === AddLecForTLecNo
      );
      ...
      let filteredArray = GetGroupwiseOptSubList.filter(
        (item) => item.Subject_Id !== excludedSub
      );
  ...
  const FilteredAddLecArray = getFilteredClassSubjects(
    AddLecForTWeekDayId,
    AddLecForTLecNo,
    AddLecPopupCompClassNameDetailsList,
    AddClassSubList
  );
  //
  ...
  const CDAGetStandardListBody: IGetTeacherAndStandardForTimeTableBody = {
    ...
    asTeacher_id:
      UserRoleId === '2' && IsWeeklyTimetableFullAccess === 'Y'
        ? 0
      ...
      const fetchData = async () => {
        try {
          await Promise.all([
            dispatch(
              CDAGetTeacherSubjectMaxLecDetailsForWeekDays(
                IGetTeacherSubjectMaxLecForWeekDay
              )
            )
          ]);
  ...
  useEffect(() => {
    if (
      isNewTeacherSelection &&
      TeacherTimetableCellValues.length > 0 &&
      WeekdayIds.length > 0 &&
      MondayColumnList?.length > 0 &&
      TuesdayColumnList?.length > 0 &&
      WednesdayColumnList?.length > 0 &&
      ThursdayColumnList?.length > 0 &&
      FridayColumnList?.length > 0
    ) {
      setTrackTeacherTimetable({});
      const abc = {};
      const WeekDaydropdownList = [
        MondayColumnList,
        TuesdayColumnList,
        WednesdayColumnList,
        ThursdayColumnList,
      ...
      TeacherTimetableCellValues.forEach((lecture) => {
        ...
        ['Text2', 'Text3', 'Text4', 'Text5', 'Text6'].forEach((day, index) => {
          let art = WeekDaydropdownList[index].filter(
  ...
  const handleTeacherSettingsClick = (
      ...
      if (checkErrorMsgLength(ValidateTeacherDataMsg[0]) === false) {
        ...
        showAlert({
          ...
          onConfirm: () => {
            ...
            dispatch(
              CDASaveTeacherTimetableWithIncr(SaveTeacherTimetableBody1)
            );
            closeAlert();
          },
          onCancel: () => {
  ...
  useEffect(() => {
    if (
      ...
      GetValidateAddDataForTeacherMsgList?.length > 0
    ) {
      if (
        GetValidateAddDataForTeacherMsgList !== undefined &&
        checkErrorMsgLength1(GetValidateAddDataForTeacherMsgList[0]) === false
      ) {
        ...
        showAlert({
          ...
          onConfirm: () => {
            if (filterBy === 'Teacher') {
              dispatch(
                CDASaveAddTeacherTimetable(
                  AddLecForTeacherApiBody,
                  DuplicateLecBody,
                  AddLecForManageTeacherApiBody,
                  ValidateAdditionalDataForTeacher
                )
              );
            } else if (filterBy === 'Class') {
              dispatch(
  ...
  function hasExternalLecture(trackTeacherTimeTable: string) {
    ...
    if (trackTeacherTimeTable !== undefined) {
      const [SubTeacherId, WeekDayId, StdDivId, SubId, LecNo] =
        trackTeacherTimeTable.split('-');
      ...
      return externalLectures.some(
        (lecture) => lecture.Text1 === weekDayName && lecture.Text2 === LecNo
      );
    }
  }
  ...
  function checkAndDispatch(trackTeacherTimeTable: string) {
    ...
    if (trackTeacherTimeTable !== undefined) {
      ...
      const additionalLecture = TimetableDetails.find(
        (item) =>
  ...
  function isMPTLecture(weekDay, lectureNo) {
    if (IsMPTApplicable) {
      let isPresent = mptInfo.find(
        (item) => item.Text1 === weekDay && item.Text2 === lectureNo
      );
  ...
  function isAssemblyLecture(weekDay, lectureNo) {
    if (IsAssemblyApplicable) {
      let isPresent = AssemblyInfo.find(
        (item) => item.Text1 === weekDay && item.Text2 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function isStaybackLecture(weekDay, lectureNo) {
    if (IsStaybackApplicable) {
      let isPresent = StayBackInfo.find(
        (item) => item.Text1 === weekDay && item.Text2 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function isWeeklyTestLecture(weekDay, lectureNo) {
    if (IsWeeklyTestApplicable) {
      let isPresent = weeklyTestInfo.find(
        (item) => item.Text1 === weekDay && item.Text2 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function isMPTLectureClass(weekDay, lectureNo) {
    if (IsMPTApplicable) {
      let isPresent = mptInfoClass.find(
        (item) => item.Text1 === weekDay && item.Text4 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
    } else {
  ...
  function isAssemblyLectureClass(weekDay, lectureNo) {
    if (IsAssemblyApplicable) {
      let isPresent = AssemblyInfoClass.find(
        (item) => item.Text1 === weekDay && item.Text4 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function isStaybackLectureClass(weekDay, lectureNo) {
    if (IsStaybackApplicable) {
      let isPresent = StaybackInfoClass.find(
        (item) => item.Text1 === weekDay && item.Text4 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function isWeeklytestLectureClass(weekDay, lectureNo) {
    if (IsWeeklyTestApplicable) {
      let isPresent = weeklytestInfoClass.find(
        (item) => item.Text1 === weekDay && item.Text4 === lectureNo
      );
      isPresent !== undefined ? true : false;
      return isPresent;
  ...
  function hasAddLect(WeekDayName, LecNo) {
    let isAdd = false;
    let isAddLec = TimetableDetails.find(
      (item) => item.Text2 === WeekDayName && item.Text1 === LecNo
    );
  ...
  function hasAddLectOnClass(WeekDayName, LecNo) {
    let isAdd = false;
    let isAddLec = OptionalLecForClass.find(
      (item) => item.Text3 === WeekDayName && item.Text2 === LecNo
    );
    if (isAddLec !== undefined) {
      isAdd = true;
    }
  ...
  function filterMaxDayLec(ArrayofWeekDayData, lecNo) {
    ...
    let newAr = ArrayofWeekDayData.filter(
      (item) => lecNumber <= parseInt(item.MaxDayLec)
    );
    newAr.unshift({
      Id: '0',
      Name: 'Select',
    ...
    if (
      ...
      WeekDays.forEach((day) => {
        let dayCount = TeacherTimetableCellValues.reduce((total, item) => {
          ...
          const dayMapping = {
            Monday: item.Text2 !== '0',
            Tuesday: item.Text3 !== '0',
            Wednesday: item.Text4 !== '0',
            Thursday: item.Text5 !== '0',
            Friday: item.Text6 !== '0'
          };
          if (item.Text1 !== '99') {
            mptCount = mpt && isMPTLecture(day, item.Text1) ? 1 : 0;
            assemblyCount =
              assembly && isAssemblyLecture(day, item.Text1) ? 1 : 0;
            staybackCount =
              stayback && isStaybackLecture(day, item.Text1) ? 1 : 0;
            weeklytestCount =
              weeklytest && isWeeklyTestLecture(day, item.Text1) ? 1 : 0;
  ...
  function SubmitAddtionalLecForClass() {
    ...
    if (
      ...
      dispatch(
        CDASaveAddClassTimetable(DuplicateLecBody, ValidateAddDataForClass)
      );
    } else {
      setIsSubmitAdLecToTeacher(true);
    }
    ...
    <>
      <Box sx={{ mx: 2 }}>
          ...
          navLinks={[
            {
              ...
              path: '/RITeSchool/Teacher/WeeklyTimetable'
            }
          ]}
          rightActions={
            <>
                  ...
                  <Box sx={{ width: { xs: '100%', sm: 'auto' } }}>
                    {filterBy === 'Teacher' && (
                      <SearchableDropdown1
                        ...
                        label="Teacher"
                        sx={{ minWidth: 250, mb: { xs: 1, sm: 'auto' } }}
                        size={'small'}
                      />
                    )}
                  </Box>
                      ...
                      <FormGroup>
                        {IsAssemblyApplicable && (
                          <FormControlLabel
                            ...
                            label={`Is ${assemblyName} Applicable?`}
                          />
                        )}
                        {IsMPTApplicable && (
                          <FormControlLabel
                            control={
                              <Checkbox checked={mpt} onChange={handleMpt} />
                            }
                            label={`Is ${mptName} Applicable?`}
                          />
                        )}
                        {IsStaybackApplicable && (
                          <FormControlLabel
                            control={
                              <Checkbox
                                checked={stayback}
                            ...
                            label={`Is ${staybackName} Applicable?`}
                          />
                        )}
                        {IsWeeklyTestApplicable && (
                          <FormControlLabel
                            control={
                              <Checkbox
                                checked={weeklytest}
                                onChange={handleWeeklytest}
                              />
                            }
                            label={`Is ${weeklytestName} Applicable?`}
                          />
                        )}
                      </FormGroup>
                    </Box>
          ...
          <Box sx={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', gap: '20px' }}>
              ...
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                />
                <Typography>
                  Associated with additional / optional subject lectures
                </Typography>
              </Box>
            </Box>
          </Box>
        ...
        <Box sx={{ p: 2, background: 'white', mt: 1 }}>
          {ValidateTeacherDataMsg?.length > 0 &&
            checkErrorMsgLength(ValidateTeacherDataMsg[0]) && (
          ...
          {ValidateClassDataMsg?.length > 0 &&
            checkErrorMsgLength(ValidateClassDataMsg[0]) && (
              <Stack sx={{ width: '100%' }} spacing={0.5}>
          ...
          >
            {filterBy === 'Teacher' ? (
              <Typography variant={'h4'}>
                ...
                {teacher !== '0' ? teacherName : 'teacher / class name'}
              </Typography>
            ) : (
              <Typography variant={'h4'}>
                Weekly timetable for{' '}
                {standard !== '0' && division !== '0'
                  ? `Class ${standardName} - ${divisionName}`
                  : 'teacher / class name'}
              </Typography>
            )}
          </Stack>
          ...
          {division !== '0' &&
            Object.keys(trackClassTimetable).length === 0 && <SuspenseLoader />}
          {loading ? (
            <SuspenseLoader />
          ) : (
            <>
                                ...
                                <>
                                  {WeekdayIds.length > 0 &&
                                    ...
                                    <TableRow key={i}>
                                          ...
                                          {mpt === true &&
                                            ...
                                            <SearchableDropdown1
                                              onChange={(value) =>
                                                clickTeacherMon(
                                                  value,
                                                  `${WeekdayIds[0].WeekdayId}-${item.Text1}`
                                                )
                                              }
                                              ItemList={filterMaxDayLec(
                                                MondayColumnList,
                                                item.Text1
                                              )}
                                              sx={{
                                          ...
                                          {mpt === true &&
                                            ...
                                            <SearchableDropdown1
                                              onChange={(value) =>
                                                clickTeacherTue(
                                                  value,
                                                  `${WeekdayIds[1]?.WeekdayId}-${item.Text1}`
                                                )
                                              }
                                              ItemList={filterMaxDayLec(
                                                TuesdayColumnList,
                                      ...
                                      <Tooltip
                                        title={`For - Wednesday : ${item.Text1}`}
                                        arrow
                                        placement="top"
                                      >
                                        <StyledCell
                                          ...
                                          {mpt === true &&
                                            ...
                                            <SearchableDropdown1
                                              onChange={(value) =>
                                                clickTeacherWed(
                                                  value,
                                                  `${WeekdayIds[2]?.WeekdayId}-${item.Text1}`
                                                )
                                              }
                                              ItemList={filterMaxDayLec(
                                                WednesdayColumnList,
                                          ...
                                          {mpt === true &&
                                            ...
                                            <SearchableDropdown1
                                              onChange={(value) =>
                                                clickTeacherThu(
                                                  value,
                                                  `${WeekdayIds[3]?.WeekdayId}-${item.Text1}`
                                                )
                                              }
                                              ItemList={filterMaxDayLec(
                                                ThursdayColumnList,
                                          ...
                                          {mpt === true &&
                                            ...
                                            <SearchableDropdown1
                                              onChange={(value) =>
                                                clickTeacherFri(
                                                  value,
                                                  `${WeekdayIds[4]?.WeekdayId}-${item.Text1}`
                                                )
                                              }
                                              ItemList={filterMaxDayLec(
                                                FridayColumnList,
                                            ...
                                            {isMPTLectureClass(
                                              ...
                                              <SearchableDropdown1
                                                onChange={(value) =>
                                                  clickClassMon(
                                                    value,
                                                    `${ClassWeeklyIds[0]?.WeekdayId}-${item.Text1}`
                                                  )
                                                }
                                                ItemList={filterMaxDayLec(
                                                  MondayColumnList,
                                            ...
                                            {isMPTLectureClass(
                                              ...
                                              <SearchableDropdown1
                                                onChange={(value) =>
                                                  clickClassTue(
                                                    value,
                                                    `${ClassWeeklyIds[1]?.WeekdayId}-${item.Text1}`
                                                  )
                                                }
                                                ItemList={filterMaxDayLec(
                                                  TuesdayColumnList,
                                            ...
                                            {isMPTLectureClass(
                                              ...
                                              <SearchableDropdown1
                                                onChange={(value) =>
                                                  clickClassWed(
                                                    value,
                                                    `${ClassWeeklyIds[2]?.WeekdayId}-${item.Text1}`
                                                  )
                                                }
                                                ItemList={filterMaxDayLec(
                                                  WednesdayColumnList,
                                            ...
                                            {isMPTLectureClass(
                                              ...
                                              <SearchableDropdown1
                                                onChange={(value) =>
                                                  clickClassThu(
                                                    value,
                                                    `${ClassWeeklyIds[3]?.WeekdayId}-${item.Text1}`
                                                  )
                                                }
                                                ItemList={filterMaxDayLec(
                                                  ThursdayColumnList,
                                            ...
                                            {isMPTLectureClass(
                                              ...
                                              <SearchableDropdown1
                                                onChange={(value) =>
                                                  clickClassFri(
                                                    value,
                                                    `${ClassWeeklyIds[4]?.WeekdayId}-${item.Text1}`
                                                  )
                                                }
                                                ItemList={filterMaxDayLec(
                                                  FridayColumnList,
                    ...
                    {OptionalLecForClass.length > 0 && (
                      <TableContainer sx={{ width: '100%' }}>
                        <Table>
                          <TableHead>
                            <TableRow>
                              <HeaderStyledCell sx={{ textAlign: 'left' }}>
                                Week Day
                              </HeaderStyledCell>
                              ...
                              <TableRow>
                                ...
                                >
                                  <Tooltip title="Delete">
                                    <IconButton
                                      onClick={() => dltAddLecture(item.Text6)}
                                      sx={{
                                        color: '#223354',
                                        '&:hover': {
                                          color: 'red',
                      ...
                      <Table>
                        <TableHead>
                          <TableRow>
                            ...
                            <HeaderStyledCell sx={{ textAlign: 'center' }}>
                              Lecture Count
                            </HeaderStyledCell>
                          </TableRow>
                        </TableHead>
                          ...
                          {LectureCountsForTeachers?.map((item, i) => {
                            ...
                            switch (item.Text2) {
                              ...
                              case 'Weekly Tests':
                                ...
                                break;
                              default: // Default to Text3 for any other cases
                                displayText3 = item.Text3;
                                break;
                            }
                            ...
                            return item.Text2 === 'Total Weekly Lectures' ? (
                              <TableRow key={i}>
                                <FooterStyledCell
                                  sx={{ textAlign: 'left' }}
                                ...
                                />
                                <FooterStyledCell sx={{ textAlign: 'center' }}>
                                  {countNonZeroPatterns() +
                                    (IsMPTApplicable &&
                                      mpt &&
                                      Number(mptCount)) +
                                    (IsStaybackApplicable &&
                                      stayback &&
                                      Number(staybackCount)) +
                                    (IsWeeklyTestApplicable &&
                                      weeklytest &&
                                      Number(weeklytestCount)) +
                                    (IsAssemblyApplicable &&
                                      assembly &&
                                      Number(assemblyCount))}
                                </FooterStyledCell>
                              </TableRow>
                            ) : ![
                              'Assembly',
                              ...
                              <TableRow key={i}>
                                ...
                                <StyledCell1 sx={{ textAlign: 'center' }}>
                                  {countSubIdOccurrences(
                                    item.Text5,
                                    item.Text4
                                  )}
                                </StyledCell1>
                          ...
                          {TimetableDetails.map((item, i) => (
                            <TableRow>
                              ...
                              >
                                <Tooltip title="Delete">
                                  <IconButton
                                    onClick={() => dltAddLecture(item.Text5)}
                                    sx={{
                                      color: '#223354',
                                      '&:hover': {
                                        color: 'red',
      ...
      <AddLecture
        ...
        ValError={DuplicateLecturesMsg?.length > 0 ? DuplicateLecturesMsg : ''}
        Open={showAddAdditionalLectures}
        onSubmit={
          filterBy === 'Teacher'
            ? SubmitAdditionalLecture
            : SubmitAddtionalLecForClass
        }
        Heading={
          filterBy === 'Teacher'
            ? `Assign additional lectures to teacher`
            : `Assign optional subject lectures to class`
        }
        OnClose={() => {
          setShowAddAdditionalLectures(false);
          dispatch(CDAClearValidateAdditionalDataForTeacher());
        }}
        ItemList2={AddLecWeekDays}
        OnChange1={(value) => {
        ...
        Defaultvalue2={AddLecForTWeekDayId}
        ErrorMsg1={
          isSubmitAdLecToTeacher && AddLecForTWeekDayId === '0' ? true : false
        }
        ItemList3={
          AddLecForTWeekDayId !== '0' ? filteredAddLecLectureNumber : []
        }
        Defaultvalue3={AddLecForTLecNo}
        OnChange2={(value) => {
        ...
        Defaultvalue4={
          filterBy === 'Teacher' ? AddLecForTStdDivId : AddLecForTSubjectNameId
        }
        OnChange3={(value) => {
          if (filterBy === 'Teacher') {
