...
const FinalResultTable = ({ IsView, ViewProgress, totalconsidration, SubjectDetailsView, IsTotalConsiderForProgressReport, showOnlyGrades, ToppersCount, hasTopRanks, PercentageDetails, TotalPerGradeView, GradesDetailsView, MarkDetailsView }) => {
