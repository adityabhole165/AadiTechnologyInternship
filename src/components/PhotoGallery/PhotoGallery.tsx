...
const PhotoGallery = ({photoList}) => {
    ...
    return (
        <>
            {showPhotoCard ?
                <PhotoCarausel item={photoList[currentIndex]} maxLength={photoList.length - 1} index={currentIndex}
                    clickClose={clickClose} clickPhotoIndex={clickPhotoIndex}></PhotoCarausel>
                :
