...
const SubjectListmainpage = () => {
    ...
    const [itemPublish,setitemPublish]=useState([ 
        ...
        { Id:"1", Text1:"4", Text2:"Miss Sakshi Anand Battale", Text3:"0", 
        IsActive:false, variant:"standard", Text4:"4",Text5:"Absent",Text6:"5",Text7:"Absent", Text8:"9", Text9:"1011",},
        { Id:"2",  Text1:"4", Text2:"Miss Sakshi Anand Battale", Text3:"0", IsActive:false,
        variant:"standard", Text4:"4",Text5:"Absent",Text6:"5",Text7:"Absent", Text8:"9", Text9:"1011",},
        { Id:"3",  Text1:"4", Text2:"Miss Sakshi Anand Battale", Text3:"0", IsActive:false,
        variant:"standard", Text4:"4",Text5:"Absent",Text6:"5",Text7:"Absent", Text8:"9", Text9:"1011",},]
        )
  ...
  return (
    <div>
      ...
      <br></br>
      <br></br>
        <SubjectList textHeader4={textHeader4} textHeader5={textHeader5}  textHeader6={textHeader6} ItemList={itemPublish}  
        onChange={Changevalue} HeaderArray={HeaderPublish} clickchange={clickchange} 
        changetextHeader4={changetextHeader4} changetextHeader5={changetextHeader5} 
        changetextHeader6={changetextHeader6}   defaultValue={Absent}Array={HeaderPublish1} 
