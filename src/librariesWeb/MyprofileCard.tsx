...
import { CardHeader, Grid , Card,Divider, CardContent,Typography,List,Box } from '@mui/material';
    ...
    <div>
       <Card sx={{backgroundColor:"#4db6ac"}}>
        <Box sx={{display:"flex"}} p={1.3}>
          ...
          <Typography> <b>Designation :</b> {DesignationName }</Typography>
          <Typography> <b>Class :</b> {ClassTeacher}</Typography>
           <Typography> <b>Date of Birth :</b> {newdate}</Typography>
           <Typography> <b>Qualification :</b> B.E </Typography>
           <Typography> <b>Mobile Number :</b> 9860168709</Typography>
           <Typography> <b>Email ID :</b> Unezad@gmail.com </Typography>
                </Grid>
                <Grid item md={5} sm={6}sx={{float:"right" }}>
                <img src={'/imges/welcomeback.png'} width={'250px'} height={'137px'} />
                  </Grid>
              </Grid>
