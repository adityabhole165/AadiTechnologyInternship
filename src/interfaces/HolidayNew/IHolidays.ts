...
export interface MonthwiseAttendanceIResult {
 ...
 export interface ISchoolSettings {
  ...
  export interface IGetSchoolSettingsResult {
    ...
    ShowRequisitionExpiryDate: boolean
    RequisitionExpiryDaysCount: number
    AllowStudentUpdateForClassTeacher: string;
    ShowOnlyCoOrdinators: boolean;
    SoftwareFeedbackLink: string;
  }