...
import {
  ...
  getTimetable,
  getAdditional
} from 'src/Client_Api/Teacher/TMtimetable';
...
import IWdays, {
  ...
  ItimeTable,
  GettimeTable
} from 'src/Interface/Student/Tmtimetable';
import Accordion7 from 'src/UI_Library/accordion/accordion7';
import ControlledAccordions from 'src/UI_Library/accordion/accordion';
