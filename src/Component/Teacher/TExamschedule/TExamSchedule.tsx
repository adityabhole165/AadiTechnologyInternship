...
import IGetAllStandards, {
  IGetExamsList
} from 'src/Interface/Teacher/TExamSchedule';
import {
  GetSelectStandardRes,
  GetSelectExamRes
} from 'src/Client_Api/Teacher/TExamschedule';
import { GetExamsListResult } from 'src/Interface/Teacher/TExamSchedule';
import { GetStandardListResult } from 'src/Interface/Teacher/TExamSchedule';
import { GetExamListResult } from 'src/Interface/Teacher/TExamSchedule';
import PageHeader from 'src/UI_Library/heading/PageHeader';
import { useEffect, useState } from 'react';
import Container from '@mui/material/Container';
import FormControl from '@mui/material/FormControl';
import NativeSelect from '@mui/material/NativeSelect';
import List15 from 'src/UI_Library/list/List15';
import Icon4 from 'src/UI_Library/icon/icon4';
import { IExamList } from 'src/Interface/Student/ExamSchedule';
import { ViewExamDataRess } from 'src/Client_Api/Student/Examschedule';
