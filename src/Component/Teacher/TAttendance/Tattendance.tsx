...
import List13 from 'src/UI_Library/list/List13';
...
import AttendanceData from 'src/Interface/Teacher/TAttendanceList';
import { getAttendanceDataList, getStandardList, GetStudentDetailsList } from 'src/Client_Api/Teacher/TAttendance';
