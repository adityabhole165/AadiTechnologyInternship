import List7 from 'src/UI_Library/list/List7';
import React, { useEffect } from 'react';
import { useDispatch } from 'react-redux';
import { useSelector } from 'react-redux';
import { RootState } from 'src/store';
import { IMsgfrom } from 'src/Interface/Student/dashboard';
import { getmsgfrom } from 'src/Client_Api/Student/Dashboard';
