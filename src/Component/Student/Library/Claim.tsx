...
import Accordion5 from 'src/UI_Library/accordion/accordion5';
import { getClaimlist } from 'src/Client_Api/Student/Library';
...
import { IClaimList, GetClaimResult } from 'src/Interface/Student/Library';
