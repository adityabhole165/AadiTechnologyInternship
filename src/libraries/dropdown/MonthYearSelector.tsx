...
const MonthYearSelector = ({ YearList, clickItem }) => {
    ...
    return (<Grid container spacing={2}>
        <Grid item xs={6}>
            <DropdownNew Itemlist={MonthList} onChange={onChangeMonth} Label="Month" DefaultValue={Month}></DropdownNew>
        </Grid>
        <Grid item xs={6}>
            <DropdownNew Itemlist={YearList} onChange={onChangeYear} Label="Year" DefaultValue={Year}></DropdownNew>
        </Grid>
    </Grid>
    )
}
