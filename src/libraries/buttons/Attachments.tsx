import { TextField, Box, ClickAwayListener, Tooltip } from '@mui/material';
...
const Attachments = () => {
  ...
  const AdharNote = 'Support only PDF, DOC, DOCX. File size should not exceed 25 MB';
  const fileChangedHandler = (event) => {
    ...
    if (!allowedFileTypes.includes(fileExtension) && fileExtension != undefined) {
