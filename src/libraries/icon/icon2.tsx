...
function Icon2({ Note }) {
    ...
    return (
        <>
            <Container>
                <Box display="flex" flexDirection="row" alignItems="center" justifyContent="space-between" sx={{marginRight:-3, mb: 2, marginTop: '-22px' }}>
                    ...
                    <ClickAwayListener onClickAway={handleClickAway}>
                        ...
                        >
                            ...
                            <InfoTwoToneIcon type="button" onClick={handleClick} sx={{ fontSize: 20, marginTop: '-1px', backgroundColor: "#e8a0e7", borderRadius: "50px" }} />
                        </Tooltip>
