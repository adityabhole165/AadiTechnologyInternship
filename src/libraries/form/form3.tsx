...
function Form() {
  ...
  const formik=useFormik({
    ...
    errors.NewPassword="Password should be combination of at least one character, digit & special character."
  }
    ...
    <Container>
      <Card sx={{ padding: '20px', backgroundColor: '#ffffffdb' }}>
        <form onSubmit={formik.handleSubmit}>
          ...
          />
          <p style={{ color: 'red' ,marginTop:-10}}>{formik.touched.Oldpassword && formik.errors.Oldpassword ? (<div>{formik.errors.Oldpassword}</div>):null}</p>
          ...
          <TextField
            ...
            sx={{mt:"-0.3rem"}}
          />
          <p style={{ color: 'red' ,marginTop:-10}}>{formik.touched.NewPassword && formik.errors.NewPassword ? (<div>{formik.errors.NewPassword}</div>):null}</p>
          ...
          <TextField
            ...
            sx={{mt:"-0.3rem"}}
          />
          <p style={{ color: 'red' ,marginTop:-10}}>{formik.touched.ConfirmPassword && formik.errors.ConfirmPassword ? (<div>{formik.errors.ConfirmPassword}</div>):null}</p>
