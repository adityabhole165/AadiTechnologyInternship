...
import {IGetITRFileNameBody,IGetITRFileNameResult,GetAllAcademicYearsApiBody,GetAllAcademicYearsResult
,GetFinancialYearDetailsBody,GetFinancialYearDetails} from "src/interfaces/Student/IIncomeTaxReport" ;
...
const getAllAcademicYears = (data: GetAllAcademicYearsApiBody) => {
    ...
    const getAllFinancialYears = (data: GetFinancialYearDetailsBody) => {
        return http.post<GetFinancialYearDetails> ('School/GetFinancialYearDetails',data);
