...
import {ISaveStudentPhotoBody,ISaveStudentPhotoResult,ISubmitStudentPhotoBody,ISubmitStudentPhotoResult} from "src/interfaces/Student/IEditProfile" ;
...
const SubmitStudentPhotoapi = (data: ISubmitStudentPhotoBody) => {
    return http.post<ISubmitStudentPhotoResult>('Student/SubmitStudentPhoto',data);
};
